...
const Svg5H = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      transform="matrix(2.779 0 0 2.60089 56.112 64.86)"
    />
    <path
      d="M3.676-9C.433-9 0-5.523 0-5.523S-.433-9-3.676-9C-5.946-9-8-7.441-8-4.5-8-.614-1.42 3.294 0 9 1.352 3.299 8-.614 8-4.5 8-7.441 5.946-9 3.676-9"
      style={{
      ...
      transform="matrix(-2.779 0 0 -2.60089 56.112 177.262)"
    />
    <path
      d="M3.676-9C.433-9 0-5.523 0-5.523S-.433-9-3.676-9C-5.946-9-8-7.441-8-4.5-8-.614-1.42 3.294 0 9 1.352 3.299 8-.614 8-4.5 8-7.441 5.946-9 3.676-9"
      style={{
      ...
      transform="matrix(2.779 0 0 2.60089 110.705 65.132)"
    />
    <path
      d="M3.676-9C.433-9 0-5.523 0-5.523S-.433-9-3.676-9C-5.946-9-8-7.441-8-4.5-8-.614-1.42 3.294 0 9 1.352 3.299 8-.614 8-4.5 8-7.441 5.946-9 3.676-9"
      style={{
      ...
      transform="matrix(-2.779 0 0 -2.60089 110.705 177.535)"
    />
    <path
      d="M3.676-9C.433-9 0-5.523 0-5.523S-.433-9-3.676-9C-5.946-9-8-7.441-8-4.5-8-.614-1.42 3.294 0 9 1.352 3.299 8-.614 8-4.5 8-7.441 5.946-9 3.676-9"
      style={{
      ...
      transform="matrix(2.779 0 0 2.60089 83.213 125.053)"
    />
  </svg>
)
