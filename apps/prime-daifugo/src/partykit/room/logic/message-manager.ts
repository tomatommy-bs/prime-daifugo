...
interface Event {
  ...
  onSetReady?: (room: Party.Room, sender: Party.Connection) => void;
  onUnsetReady?: (room: Party.Room, sender: Party.Connection) => void;
  onStartGame?: (room: Party.Room, sender: Party.Connection) => void;
}
...
export class MessageManager {
  ...
  onMessage(room: Party.Room, payload: string, sender: Party.Connection) {
